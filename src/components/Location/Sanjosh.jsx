    ...
    return (
        <>
            ...
            <div className=' max-w-7xl mx-auto'>
                ...
                <div>
                    <h2 className='text-xl font-bold mt-5 mb-5'>🌆 Travel to San Jose with 7upTravel</h2>
                    ...
                    <h2 className='text-xl font-bold mt-5 mb-5'>✈️ Flights to San Jose</h2>
                    ...
                    <h2 className='text-xl font-bold mt-5 mb-5'>🚗 Car Rentals in San Jose</h2>
                    <ul className='text-gray-500 list-disc pl-20'>
                    ...
                    <h2 className='text-xl font-bold mt-5 mb-5'>📍 Top Attractions to Explore</h2>
                    <ul className='text-gray-500 list-disc pl-20'>
